...
(use-package evil-multiedit
  ...
  (evil-define-key 'normal evil-multiedit-mode-map "Z" #'evil-multiedit-match-symbol-and-prev)
...
(use-package consult
  ...
  (evil-define-key 'normal 'global (kbd "C-x C-b") #'consult-buffer-other-window)
...
(use-package eglot
  ...
  (setq eldoc-idle-delay 9999) ;; <--- Is there a cleaner way to do this?
  (setq eglot-ignored-server-capabilities '(:documentHighlightProvider :colorProvider))
  ...
  (evil-define-key 'normal 'global (kbd "gh") #'eldoc))
